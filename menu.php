...
$mensaje_bienvenida = "Bienvenido Administrador";
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <style>
        ...
        /* Hacer que el contenido se muestre correctamente */
        .content {
            margin-left: 0;
            padding: 20px;
        }

        /* Hacer que los enlaces del menú sean más pequeños */
        .sidebar a {
            font-size: 14px;
            padding: 10px 12px;
        }

        /* Mostrar el icono en lugar de texto en dispositivos móviles */
        .sidebar a:not(.submenu-toggle)::before {
        ...
        /* Al hacer clic en el submenu, mostrarlo */
        .submenu.show {
            display: block;
        }

        /* Cambiar la apariencia de la barra lateral */
        .sidebar {
            position: absolute;
            z-index: 1000;
            top: 0;
        ...
        /* Icono del menú de hamburguesa (para abrir la barra lateral) */
        .hamburger-menu {
            display: block;
            font-size: 24px;
            cursor: pointer;
...
<div class="hamburger-menu" onclick="toggleSidebar()">☰</div>
    ...
    <div class="content">
        ...
        <p>Bienvenido a la página principal. Selecciona una opción del menú para comenzar.</p>
    </div>
